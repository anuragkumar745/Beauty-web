...
const Home = () => {
  ...
  const homeSchema = {
    ...
    "@type": "BeautySalon",
    "name": "Volume Salon - Best Hair & Beauty Salon in Ranchi",
    "image": "https://volumesalonranchi.app/assets/hero_bg.jpg",
    "priceRange": "₹₹",
    "telephone": "+918434300344",
    "address": {
      "@type": "PostalAddress",
  ...
  return (
    <div className="bg-champagne dark:bg-luxury-black transition-colors duration-300 min-h-screen text-luxury-black dark:text-white">
      <SEO title="Best Hair & Beauty Salon in Ranchi, Jharkhand" description="Volume Salon is Ranchi's premium beauty destination for expert bridal makeup, advanced hair styling, professional nail design, skin care facials, and luxury spa treatments. 5.0★ rated with 31+ reviews." schema={homeSchema} />
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center text-white flex flex-col items-center gap-6 md:gap-8 mt-12">
          ...
          >
            Experience premium salon care customized to highlight your unique grace. Ranchi's finest styling destination offering certified hair design, luxury bridal makeovers, and specialized nail artistry.
          </motion.p>
          ...
          >
            ...
            <a href="https://wa.me/918434300344" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto cursor-pointer">
              <Button variant="secondary" className="w-full sm:w-auto" icon={<FaWhatsapp className="text-lg" />}>
                WhatsApp Us
              </Button>
            </a>
            <a href="tel:+918434300344" className="w-full sm:w-auto cursor-pointer">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col gap-6">
          <span className="text-primary text-xs uppercase tracking-[0.3em] font-semibold">About Volume Salon</span>
          ...
          <p className="text-luxury-gray dark:text-white/80 text-xs md:text-sm font-light leading-relaxed">
            Volume Salon represents the zenith of premium aesthetic wellness in Ranchi, Jharkhand. Our mission is to deliver customized beauty experiences with uncompromising quality, impeccable hygiene, and luxurious comfort.
          </p>
      ...
      <section className="py-24 bg-white dark:bg-luxury-dark transition-colors duration-300 border-y border-primary/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
            ...
            {/* Service 4: Spa Facials */}
            <div className="bg-champagne dark:bg-luxury-black/50 rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 border border-primary/10 dark:border-primary/20 flex flex-col justify-between">
              <div className="aspect-[4/3] overflow-hidden">
                <img src={spaTreatment} alt="Luxury spa treatment facial" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="p-6 flex flex-col flex-grow justify-between">
                <div>
                  <span className="text-primary text-[10px] uppercase font-bold tracking-widest">Skin Care</span>
                  <h3 className="font-serif text-lg font-bold mt-1 mb-2">Deep Cleansing Hydra Facial</h3>
                  <p className="text-luxury-light-gray dark:text-white/50 text-xs font-light leading-relaxed mb-6">Revitalizing pore extraction treatment to remove impurities, restore deep hydration, and leave skin glowing.</p>
                </div>
                <div className="flex items-center justify-between border-t border-primary/10 dark:border-primary/20 pt-4">
                  <span className="font-serif font-bold text-primary-dark dark:text-primary">₹2,500</span>
                  <Link to="/booking?service=Deep%20Cleansing%20%26%20Hydra%20Care" className="cursor-pointer">
                    <Button variant="secondary" className="text-[10px] px-4 py-2">Book Now</Button>
                  </Link>
                </div>
              </div>
      ...
      <section className="py-24 bg-luxury-black text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-bold mt-2">Why Choose Volume Salon?</h2>
          </div>
      ...
      <section className="py-24 bg-white dark:bg-luxury-dark transition-colors duration-300 border-t border-primary/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-bold mt-2">The Volume Journal</h2>
          </div>
